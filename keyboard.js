 ...
 *	   * CSS update
 *    * Creates Bookmarklet
 *    * Removed useless features (size, etc.)
 *    * updated HTML code (ul/li:select/option, less <tables>)
 *    * improved performances by reducing amount of regenerations of the KB
 *    * keyboard image (top-right : clicable to disable it) + BASE64 images : one less request
 *    * Add drag'n'drop support
 *
 *    TODO:
 *     - add french BEPO layout
 *     - rewrite some parts of code
 *     - remove ths useless parts
 *
 */
...
function VKI_init() {
	...
	param[0] = (param[0] == "") ? "us-int" : unescape(param[0]); // default Keyboard layout : US INT
	var CssURI=params[0]+".css";
	this.VKI_emulate = (param[1]) ? true : false;
	this.VKI_target = false;
	this.VKI_shift = this.VKI_shiftlock = false;
	this.VKI_altgr = this.VKI_altgrlock = false;
	this.VKI_kts = this.VKI_kt = param[0];
	this.VKI_imageURI_r = 'data:image/gif;base64,R0lGODdhHAANAIACAAAAAP8AACwAAAAAHAANAAACMoyPqXtgHqB8NFaLZ64T+A+GophoJteU6MZa4wt/KXtiM71qacyTiM7QQWbD4MXRS3oKADs=';	// red KB image
	this.VKI_imageURI_g = 'data:image/gif;base64,R0lGODdhHAANAIACAAAAAAD/gCwAAAAAHAANAAACMoyPqXtgHqB8NFaLZ64T+A+GophoJteU6MZa4wt/KXtiM71qacyTiM7QQWbD4MXRS3oKADs=';	// red KB image

	this.VKI_clickless = 0; // point to click : 0 = disabled, >0 = delay in ms (recommended : 400 to 800)
	...
	this.VKI_layout['albanian'] = {
	 'name': "Albanian - Shqip", 'keys': [
	...
	this.VKI_layout['armenian-e'] = {
	 'name': "Armenian E. - \u0540\u0561\u0575\u0565\u0580\u0565\u0576 \u0561\u0580\u0565\u0582\u0565\u056c\u0584", 'keys': [
	...
	this.VKI_layout['armenian-w'] = {
	 'name': "Armenian W. - \u0540\u0561\u0575\u0565\u0580\u0565\u0576 \u0561\u0580\u0565\u0582\u0574\u0578\u0582\u057f\u0584", 'keys': [
		[["\u055D", "\u055C"], [":", "1"], ["\u0571", "\u0541"], ["\u0575", "\u0545"], ["\u055B", "3"], [",", "4"], ["-", "9"], [".", "\u0587"], ["\u00AB", "("], ["\u00BB", ")"], ["\u0585", "\u0555"], ["\u057C", "\u054C"], ["\u056A", "\u053A"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['assamese'] = {
	 'name': "Assamese - \u0985\u09b8\u09ae\u09c0\u09df\u09be", 'keys': [
		[["+", "?"], ["\u09E7", "{", "\u09E7"], ["\u09E8", "}", "\u09E8"], ["\u09E9", "\u09CD\u09F0", "\u09E9"], ["\u09EA", "\u09F0\u09CD", "\u09EA"], ["\u09EB", "\u099C\u09CD\u09F0", "\u09EB"], ["\u09EC", "\u0995\u09CD\u09B7", "\u09EC"], ["\u09ED", "\u0995\u09CD\u09F0", "\u09ED"], ["\u09EE", "\u09B6\u09CD\u09F0", "\u09EE"], ["\u09EF", "(", "\u09EF"], ["\u09E6", ")", "\u09E6"], ["-", ""], ["\u09C3", "\u098B", "\u09E2", "\u09E0"], ["Bksp", "Bksp"]],
		[["Tab", "Tab"], ["\u09CC", "\u0994", "\u09D7"], ["\u09C8", "\u0990"], ["\u09BE", "\u0986"], ["\u09C0", "\u0988", "\u09E3", "\u09E1"], ["\u09C2", "\u098A"], ["\u09F1", "\u09AD"], ["\u09B9", "\u0999"], ["\u0997", "\u0998"], ["\u09A6", "\u09A7"], ["\u099C", "\u099D"], ["\u09A1", "\u09A2", "\u09DC", "\u09DD"], ["\u09BC", "\u099E"], [""]],
		[["Caps", "Caps"], ["\u09CB", "\u0993", "\u09F4", "\u09F5"], ["\u09C7", "\u098F", "\u09F6", "\u09F7"], ["\u09CD", "\u0985", "\u09F8", "\u09F9"], ["\u09BF", "\u0987", "\u09E2", "\u098C"], ["\u09C1", "\u0989"], ["\u09AA", "\u09AB"], ["\u09F0", "", "\u09F0", "\u09F1"], ["\u0995", "\u0996"], ["\u09A4", "\u09A5"], ["\u099A", "\u099B"], ["\u099F", "\u09A0"], ["Enter", "Enter"]],
		[["Shift", "Shift"], ["\u09CE", "\u0983"], ["\u0982", "\u0981", "\u09FA"], ["\u09AE", "\u09A3"], ["\u09A8", "\u09F7"], ["\u09AC", "\""], ["\u09B2", "'"], ["\u09B8", "\u09B6"], [",", "\u09B7"], [".", ";"], ["\u09AF", "\u09DF"], [""], ["Shift", "Shift"]],
		[[" ", " ", " ", " "], ["AltGr", "AltGr"]]
	 ], 'lang': ["as"] };

	this.VKI_layout['azebaijani-cyr'] = {
	 'name': "Azerbaijani Cyr - \u0410\u0437\u04d9\u0440\u0431\u0430\u0458\u04b9\u0430\u043d\u04b9\u0430", 'keys': [
	...
	this.VKI_layout['azebaijani-lat'] = {
	 'name': "Azerbaijani Lat - Az\u0259rbaycanca", 'keys': [
	...
	this.VKI_layout['belarusian'] = {
	 'name': "Belarusian - \u0411\u0435\u043b\u0430\u0440\u0443\u0441\u043a\u0430\u044f", 'keys': [
	...
	this.VKI_layout['bengali'] = {
	 'name': "Bengali - \u09ac\u09be\u0982\u09b2\u09be", 'keys': [
	...
	this.VKI_layout['bosnian'] = {
	 'name': "Bosnian - Bosanski", 'keys': [
	...
	this.VKI_layout['bulgarian-ph'] = {
	 'name': "Bulgarian Ph. - \u0411\u044a\u043b\u0433\u0430\u0440\u0441\u043a\u0438 \u0424\u043e\u043d\u0435\u0442\u0438\u0447\u0435\u043d", 'keys': [
	...
	this.VKI_layout['bulgarian-bds'] = {
	 'name': "Bulgarian BDS - \u0411\u044a\u043b\u0433\u0430\u0440\u0441\u043a\u0438", 'keys': [
	...
	this.VKI_layout['burmese'] = {
	 'name': "Burmese - \u1019\u103c\u1014\u103a\u1019\u102c\u1018\u102c\u101e\u102c", 'keys': [
	...
	this.VKI_layout['canadian-fr'] = {
	 'name': "Canadian Fr - Canadienne-Fr", 'keys': [
		[["#", "|", "\\"], ["1", "!", "\u00B1"], ["2", '"', "@"], ["3", "/", "\u00A3"], ["4", "$", "\u00A2"], ["5", "%", "\u00A4"], ["6", "?", "\u00AC"], ["7", "&", "\u00A6"], ["8", "*", "\u00B2"], ["9", "(", "\u00B3"], ["0", ")", "\u00BC"], ["-", "_", "\u00BD"], ["=", "+", "\u00BE"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['chinese-bapomofo-ime'] = {
	 'name': "Chinese Bopomofo IME - \u4e2d\u6587\u6ce8\u97f3\u7b26\u53f7", 'keys': [
	...
	this.VKI_layout['chinese-cangjie-ime'] = {
	 'name': "Chinese Cangjie IME - \u4e2d\u6587\u4ed3\u9889\u8f93\u5165\u6cd5", 'keys': [
		[["\u20AC", "~"], ["1", "!"], ["2", "@"], ["3", "#"], ["4", "$"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", ")"], ["0", "("], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['czech'] = {
	 'name': "Czech - \u010cesky", 'keys': [
	...
	this.VKI_layout['devanagari'] = {
	 'name': "Devanagari - \u0926\u0947\u0935\u0928\u093e\u0917\u0930\u0940", 'keys': [
	...
	this.VKI_layout['divehi'] = {
	 'name': "Divehi - \u078b\u07a8\u0788\u07ac\u0780\u07a8\u0784\u07a6\u0790\u07b0", 'keys': [
		[["`", "~"], ["1", "!"], ["2", "@"], ["3", "#"], ["4", "$"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", ")"], ["0", "("], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['esperanto'] = {
	 'name': "Esperanto", 'keys': [
		[["\u00b2", "\u00b3"], ["&", "1"], ["\u00e9", "2", "~"], ['"', "3", "#"], ["'", "4", "{"], ["(", "5", "["], ["-", "6", "|"], ["\u00e8", "7", "`"], ["_", "8", "\\"], ["\u00e7", "9", "^"], ["\u00e0", "0", "@"], [")", "\u00b0", "]"], ["=", "+", "}"], ["Bksp", "Bksp"]],
		[["Tab", "Tab"], ["a", "A"], ["z", "Z"], ["e", "E", "\u20ac"], ["r", "R"], ["t", "T"], ["u", "U", "\u016D", "\u016C"], ["i", "I"], ["o", "O"], ["p", "P"], ["^", "\u00a8"], ["$", "\u00a3", "\u00a4"], ["*", "\u03bc"], [""]],
		[["Caps", "Caps"], ["s", "S", "\u015D", "015C"], ["d", "D"], ["f", "F"], ["g", "G", "\u011D", "\u011C"], ["h", "H", "\u0125", "\u0124"], ["j", "J", "\u0135", "\u0134"], ["k", "K"], ["l", "L"], ["m", "M"], ["\u00f9", "%"], [""], ["Enter", "Enter"]],
		[["Shift", "Shift"], ["<", ">"],  ["c", "C", "\u0109", "\u0108"], ["v", "V"], ["b", "B"], ["n", "N"], [",", "?"], [";", "."], [":", "/"], ["!", "\u00a7"], [""], [""], ["Shift", "Shift"]],
		[[" ", " ", " ", " "], ["AltGr", "AltGr"]]
	 ], 'lang': ["eo"] };


	this.VKI_layout['estonian'] = {
	 'name': "Estonian - Eesti", 'keys': [
	...
	this.VKI_layout['farsi'] = {
	 'name': "Farsi - \u0641\u0627\u0631\u0633\u06cc", 'keys': [
	...
	this.VKI_layout['faeroese'] = {
	 'name': "Faeroese - F\u00f8royskt", 'keys': [
		[["\u00BD", "\u00A7"], ["1", "!"], ["2", '"', "@"], ["3", "#", "\u00A3"], ["4", "\u00A4", "$"], ["5", "%", "\u20AC"], ["6", "&"], ["7", "/", "{"], ["8", "(", "["], ["9", ")", "]"], ["0", "=", "}"], ["+", "?"], ["\u00B4", "`", "|"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['french'] = {
	 'name': "French - Fran\u00e7ais", 'keys': [
		[["\u00b2", "\u00b3", "\u00b9", "\u00B8"], ["&", "1", "\u02C7", "\u02DB"], ["\u00e9", "2", "~", "\u00c9"], ['"', "3", "#", "\u02d8"], ["'", "4", "{", "\u2014"], ["(", "5", "[", "\u2013"], ["-", "6", "|", "\u2011"], ["\u00e8", "7", "`", "\u00c8"], ["_", "8", "\\", "\u2122"], ["\u00e7", "9", "^", "\u00c7"], ["\u00e0", "0", "@", "\u00c0"], [")", "\u00b0", "]", "\u2260"], ["=", "+", "}", "\u00b1"], ["Bksp", "Bksp"]],
		[["Tab", "Tab"], ["a", "A", "\u00e6", "\u00c6"], ["z", "Z", "\u00e2", "\u00c2"], ["e", "E", "\u20ac", "\u00a2"], ["r", "R", "\u00ea", "\u00ca"], ["t", "T", "\u00fe", "\u00de"], ["y", "Y", "\u00ff", "\u0178"], ["u", "U", "\u00fb", "\u00db"], ["i", "I", "\u00ee", "\u00ce"], ["o", "O", "\u0153", "\u0152"], ["p", "P", "\u00f4", "\u00d4"], ["^", "\u00a8", "~", "\u00b0"], ["$", "\u00a3", "\u00a4", "\u00d8"], ["*", "\u03bc", "\u0060", "\u00af"]],
		[["Caps", "Caps"], ["q", "Q", "\u00e4", "\u00c4"], ["s", "S", "\u00df", "\u201e"], ["d", "D", "\u00eb", "\u00cb"], ["f", "F", "\u2018", "\u201a"], ["g", "G", "\u2018", "\u00a5"], ["h", "H", "\u00f0", "\u00d0"], ["j", "J", "\u00fc", "\u00dc"], ["k", "K", "\u00ef", "\u00cf"], ["l", "L", "\u0140", "\u013f"], ["m", "M", "\u00f6", "\u00d6"], ["\u00f9", "%", "\u00b4", "\u00d9"], ["Enter", "Enter"]],
		[["Shift", "Shift"], ["<", ">", "\u2264", "\u2265"], ["w", "W", "\u00ab", "\u201c"], ["x", "X", "\u00bb", "\u201d"], ["c", "C", "\u00a9", "\u00ae"], ["v", "V", "", "\u2190"], ["b", "B", "\u2193", "\u2191"], ["n", "N", "\u00ac", "\u2192"], [",", "?", "\u00bf", "\u2026"], [";", ".", "\u00d7", "\u22C5"], [":", "/", "\u00f7", "\u2215"], ["!", "\u00a7", "\u0021", "\u2212"], ["Shift", "Shift"]],
		[[" ", " ", " ", " "], ["AltGr", "AltGr"]]
	 ], 'lang': ["fr"] };

	this.VKI_layout['georgian'] = {
	 'name': "Georgian - \u10e5\u10d0\u10e0\u10d7\u10e3\u10da\u10d8", 'keys': [
		[["\u201E", "\u201C"], ["!", "1"], ["?", "2"], ["\u2116", "3"], ["\u00A7", "4"], ["%", "5"], [":", "6"], [".", "7"], [";", "8"], [",", "9"], ["/", "0"], ["\u2013", "-"], ["=", "+"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['gujurati'] = {
	 'name': "Gujarati - \u0a97\u0ac1\u0a9c\u0ab0\u0abe\u0aa4\u0ac0", 'keys': [
	...
	this.VKI_layout['hindi'] = {
	 'name': "Hindi - \u0939\u093f\u0902\u0926\u0940", 'keys': [
	...
	this.VKI_layout['icelandic'] = {
	 'name': "Icelandic - \u00cdslenska", 'keys': [
	...
	this.VKI_layout['irish-gaelic'] = {
	 'name': "Irish/Gaelic - Gaeilge", 'keys': [
		[["`", "\u00AC", "\u00A6", "\u00A6"], ["1", "!"], ["2", '"'], ["3", "\u00A3"], ["4", "$", "\u20AC"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['japanese-kana'] = {
	 'name': "Japanese Kana - \u65e5\u672c\u8a9e", 'keys': [
		[["\uff5e"], ["\u306c", "\u30cc"], ["\u3075", '\u30d5'], ["\u3042", "\u30a2", "\u3041", "\u30a1"], ["\u3046", "\u30a6", "\u3045", "\u30a5"], ["\u3048", "\u30a8", "\u3047", "\u30a7"], ["\u304a", "\u30aa", "\u3049", "\u30a9"], ["\u3084", "\u30e4", "\u3083", "\u30e3"], ["\u3086", "\u30e6", "\u3085", "\u30e5"], ["\u3088", "\u30e8", "\u3087", "\u30e7"], ["\u308f", "\u30ef", "\u3092", "\u30f2"], ["\u307b", "\u30db", "\u30fc", "\uff1d"], ["\u3078", "\u30d8" , "\uff3e", "\uff5e"], ["Bksp", "Bksp"]],
		[["Tab", "Tab"], ["\u305f", "\u30bf"], ["\u3066", "\u30c6"], ["\u3044", "\u30a4", "\u3043", "\u30a3"], ["\u3059", "\u30b9"], ["\u304b", "\u30ab"], ["\u3093", "\u30f3"], ["\u306a", "\u30ca"], ["\u306b", "\u30cb"], ["\u3089", "\u30e9"], ["\u305b", "\u30bb"], /*["\u3001", "\u3001", "\uff20", "\u2018"],*/ ["\u3002", "\u3002", "\u300c", "\uff5b"], ['\u309B', '"', "\uffe5", "\uff5c"], ["\u3080", "\u30e0", "\u300d", "\uff5d"]],
		[["Caps", "Caps"], ["\u3061", "\u30c1"], ["\u3068", "\u30c8"], ["\u3057", "\u30b7"], ["\u306f", "\u30cf"], ["\u304d", "\u30ad"], ["\u304f", "\u30af"], ["\u307e", "\u30de"], ["\u306e", "\u30ce"], ["\u308a", "\u30ea", "\u300d", "\uff5d"], ["\u308c", "\u30ec", "\uff1b", "\uff0b"], ["\u3051", "\u30b1", "\uff1a", "\u30f6"], ["Enter", "Enter"]],
		[["Shift", "Shift"], ["\u3064", "\u30c4"], ["\u3055", "\u30b5"], ["\u305d", "\u30bd"], ["\u3072", "\u30d2"], ["\u3053", "\u30b3"], ["\u307f", "\u30df"], ["\u3082", "\u30e2"], ["\u306d", "\u30cd", "\u3001", "\uff1c"], ["\u308b", "\u30eb", "\u3002", "\uff1e"], ["\u3081", "\u30e1", "\u30fb", "\uff1f"], ["\u308d", "\u30ed", "", "\uff3f"], ["Shift", "Shift"]],
		[["AltLk", "AltLk"], [" ", " ", " ", " "], ["Alt", "Alt"]]
	 ], 'lang': ["ja"] };

	this.VKI_layout['kazakh'] = {
	 'name': "Kazakh - \u049a\u0430\u0437\u0430\u049b\u0448\u0430", 'keys': [
	...
	this.VKI_layout['kannada'] = {
	 'name': "Kannada - \u0c95\u0ca8\u0ccd\u0ca8\u0ca1", 'keys': [
		[["\u0CCA", "\u0C92"], ["1", "", "\u0CE7"], ["2", "", "\u0CE8"], ["3", "\u0CCD\u0CB0", "\u0CE9"], ["4", "\u0CB0\u0CCD", "\u0CEA"], ["5", "\u0C9C\u0CCD\u0C9E", "\u0CEB"], ["6", "\u0CA4\u0CCD\u0CB0", "\u0CEC"], ["7", "\u0C95\u0CCD\u0CB7", "\u0CED"], ["8", "\u0CB6\u0CCD\u0CB0", "\u0CEE"], ["9", "(", "\u0CEF"], ["0", ")", "\u0CE6"], ["-", "\u0C83"], ["\u0CC3", "\u0C8B", "\u0CC4", "\u0CE0"], ["Bksp", "Bksp"]],
		[["Tab", "Tab"], ["\u0CCC", "\u0C94"], ["\u0CC8", "\u0C90", "\u0CD6"], ["\u0CBE", "\u0C86"], ["\u0CC0", "\u0C88", "", "\u0CE1"], ["\u0CC2", "\u0C8A"], ["\u0CAC", "\u0CAD"], ["\u0CB9", "\u0C99"], ["\u0C97", "\u0C98"], ["\u0CA6", "\u0CA7"], ["\u0C9C", "\u0C9D"], ["\u0CA1", "\u0CA2"], ["", "\u0C9E"], ['']],
		[["Caps", "Caps"], ["\u0CCB", "\u0C93"], ["\u0CC7", "\u0C8F", "\u0CD5"], ["\u0CCD", "\u0C85"], ["\u0CBF", "\u0C87", "", "\u0C8C"], ["\u0CC1", "\u0C89"], ["\u0CAA", "\u0CAB", "", "\u0CDE"], ["\u0CB0", "\u0CB1"], ["\u0C95", "\u0C96"], ["\u0CA4", "\u0CA5"], ["\u0C9A", "\u0C9B"], ["\u0C9F", "\u0CA0"], ["Enter", "Enter"]],
		[["Shift", "Shift"], ["\u0CC6", "\u0C8F"], ["\u0C82"], ["\u0CAE", "\u0CA3"], ["\u0CA8"], ["\u0CB5"], ["\u0CB2", "\u0CB3"], ["\u0CB8", "\u0CB6"], [",", "\u0CB7"], [".", "|"], ["\u0CAF"], [''], ["Shift", "Shift"]],
		[[" ", " ", " ", " "], ["AltGr", "AltGr"]]
	 ], 'lang': ["kn"] };

	this.VKI_layout['khmer'] = {
	 'name': "Khmer - \u1797\u17b6\u179f\u17b6\u1781\u17d2\u1798\u17c2\u179a", 'keys': [
	...
	this.VKI_layout['korean'] = {
	 'name': "Korean - \ud55c\uad6d\uc5b4", 'keys': [
	...
	this.VKI_layout['kurdish'] = {
	 'name': "Kurdish - Kurd\u00ee", 'keys': [
	...
	this.VKI_layout['kyrgyz'] = {
	 'name': "Kyrgyz - \u041a\u044b\u0440\u0433\u044b\u0437\u0447\u0430", 'keys': [
		[["\u0451", "\u0401"], ["1", "!"], ["2", '"'], ["3", "\u2116"], ["4", ";"], ["5", "%"], ["6", ":"], ["7", "?"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['latvian'] = {
	 'name': "Latvian - Latvie\u0161u", 'keys': [
	...
	this.VKI_layout['macedonian-cyr'] = {
	 'name': "Macedonian Cyr. - \u041c\u0430\u043a\u0435\u0434\u043e\u043d\u0441\u043a\u0438", 'keys': [
		[["`", "~"], ["1", "!"], ["2", "\u201E"], ["3", "\u201C"], ["4", "\u2019"], ["5", "%"], ["6", "\u2018"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['malayalam'] = {
	 'name': "Malayalam - \u0d2e\u0d32\u0d2f\u0d3e\u0d33\u0d02", 'keys': [
	...
	this.VKI_layout['maltese48'] = {
	 'name': "Maltese 48 - Malti", 'keys': [
	...
	this.VKI_layout['marathi'] = {
	 'name': "Marathi - \u092e\u0930\u093e\u0920\u0940", 'keys': [
	...
	this.VKI_layout['mongolian-cyr'] = {
	 'name': "Mongolian Cyr. - \u041c\u043e\u043d\u0433\u043e\u043b", 'keys': [
	...
	this.VKI_layout['pashto'] = {
	 'name': "Pashto - \u067e\u069a\u062a\u0648", 'keys': [
	...
	this.VKI_layout['polish'] = {
	 'name': "Polish - Polski", 'keys': [
		[["\u02DB", "\u00B7"], ["1", "!", "~"], ["2", '"', "\u02C7"], ["3", "#", "^"], ["4", "\u00A4", "\u02D8"], ["5", "%", "\u00B0"], ["6", "&", "\u02DB"], ["7", "/", "`"], ["8", "(", "\u00B7"], ["9", ")", "\u00B4"], ["0", "=", "\u02DD"], ["+", "?", "\u00A8"], ["'", "*", "\u00B8"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['polish-prog'] = {
	 'name': "Polish Programmers - Polski Programisty", 'keys': [
		[["`", "~"], ["1", "!"], ["2", "@"], ["3", "#"], ["4", "$"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['portuguese-br'] = {
	 'name': "Portuguese (Brazil) - Portugu\u00eas (Brazil)", 'keys': [
		[["'", '"'], ["1", "!", "\u00b9"], ["2", "@", "\u00b2"], ["3", "#", "\u00b3"], ["4", "$", "\u00a3"], ["5", "%", "\u00a2"], ["6", "\u00a8", "\u00ac"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+", "\u00a7"], ["Bksp", "Bksp"]],
		[["Tab", "Tab"], ["q", "Q", "/"], ["w", "W", "?"], ["e", "E", "\u20ac"], ["r", "R"], ["t", "T"], ["y", "Y"], ["u", "U"], ["i", "I"], ["o", "O"], ["p", "P"], ["\u00b4", "`"], ["[", "{", "\u00aa"], ["]", "}", "\u00ba"]],
		[["Caps", "Caps"], ["a", "A"], ["s", "S"], ["d", "D"], ["f", "F"], ["g", "G"], ["h", "H"], ["j", "J"], ["k", "K"], ["l", "L"], ["\u00e7", "\u00c7"], ["~", "^"], ["Enter", "Enter"]],
		[["Shift", "Shift"], ["z", "Z"], ["x", "X"], ["c", "C", "\u20a2"], ["v", "V"], ["b", "B"], ["n", "N"], ["m", "M"], [",", "<"], [".", ">"], ["\\", ":"], ["/", "?"], ["Shift", "Shift"]],
		[[" ", " ", " ", " "], ["AltGr", "AltGr"]]
	 ], 'lang': ["pt-BR"] };

	this.VKI_layout['portuguese'] = {
	 'name': "Portuguese - Portugu\u00eas", 'keys': [
		[["\\", "|"], ["1", "!"], ["2", '"', "@"], ["3", "#", "\u00a3"], ["4", "$", "\u00a7"], ["5", "%"], ["6", "&"], ["7", "/", "{"], ["8", "(", "["], ["9", ")", "]"], ["0", "=", "}"], ["'", "?"], ["\u00ab", "\u00bb"], ["Bksp", "Bksp"]],
		[["Tab", "Tab"], ["q", "Q"], ["w", "W"], ["e", "E", "\u20ac"], ["r", "R"], ["t", "T"], ["y", "Y"], ["u", "U"], ["i", "I"], ["o", "O"], ["p", "P"], ["+", "*", "\u00a8"], ["\u00b4", "`"], ["~", "^"]],
	...
	this.VKI_layout['punjabi'] = {
	 'name': "Punjabi (Gurmukhi) - \u0a2a\u0a70\u0a1c\u0a3e\u0a2c\u0a40", 'keys': [
		[[""], ["1", "\u0A4D\u0A35", "\u0A67", "\u0A67"], ["2", "\u0A4D\u0A2F", "\u0A68", "\u0A68"], ["3", "\u0A4D\u0A30", "\u0A69", "\u0A69"], ["4", "\u0A71", "\u0A6A", "\u0A6A"], ["5", "", "\u0A6B", "\u0A6B"], ["6", "", "\u0A6C", "\u0A6C"], ["7", "", "\u0A6D", "\u0A6D"], ["8", "", "\u0A6E", "\u0A6E"], ["9", "(", "\u0A6F", "\u0A6F"], ["0", ")", "\u0A66", "\u0A66"], ["-"], [""], ["Bksp", "Bksp"]],
		[["Tab", "Tab"], ["\u0A4C", "\u0A14"], ["\u0A48", "\u0A10"], ["\u0A3E", "\u0A06"], ["\u0A40", "\u0A08"], ["\u0A42", "\u0A0A"], ["\u0A2C", "\u0A2D"], ["\u0A39", "\u0A19"], ["\u0A17", "\u0A18", "\u0A5A", "\u0A5A"], ["\u0A26", "\u0A27"], ["\u0A1C", "\u0A1D", "\u0A5B", "\u0A5B"], ["\u0A21", "\u0A22", "\u0A5C", "\u0A5C"], ["\u0A3C", "\u0A1E"], ['']],
		[["Caps", "Caps"], ["\u0A4B", "\u0A13"], ["\u0A47", "\u0A0F"], ["\u0A4D", "\u0A05"], ["\u0A3F", "\u0A07"], ["\u0A41", "\u0A09"], ["\u0A2A", "\u0A2B", "\u0A5E", "\u0A5E"], ["\u0A30"], ["\u0A15", "\u0A16", "\u0A59", "\u0A59"], ["\u0A24", "\u0A25"], ["\u0A1A", "\u0A1B"], ["\u0A1F", "\u0A20"], ["Enter", "Enter"]],
		[["Shift", "Shift"], [""], ["\u0A02", "\u0A02"], ["\u0A2E", "\u0A23"], ["\u0A28"], ["\u0A35", "\u0A72", "\u0A73", "\u0A73"], ["\u0A32", "\u0A33"], ["\u0A38", "\u0A36"], [","], [".", "|", "\u0965", "\u0965"], ["\u0A2F"], [''], ["Shift", "Shift"]],
		[[" ", " ", " ", " "], ["AltGr", "AltGr"]]
	 ], 'lang': ["pa"] };

	this.VKI_layout['romanian'] = {
	 'name': "Romanian - Rom\u00e2n\u0103", 'keys': [
		[["\u201E", "\u201D", "`", "~"], ["1", "!", "~"], ["2", "@", "\u02C7"], ["3", "#", "^"], ["4", "$", "\u02D8"], ["5", "%", "\u00B0"], ["6", "^", "\u02DB"], ["7", "&", "`"], ["8", "*", "\u02D9"], ["9", "(", "\u00B4"], ["0", ")", "\u02DD"], ["-", "_", "\u00A8"], ["=", "+", "\u00B8", "\u00B1"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['serbian'] = {
	 'name': "Serbian Cyr - \u0441\u0440\u043f\u0441\u043a\u0438", 'keys': [
		[["`", "~"], ["1", "!"], ["2", '"'], ["3", "#"], ["4", "$"], ["5", "%"], ["6", "&"], ["7", "/"], ["8", "("], ["9", ")"], ["0", "="], ["'", "?"], ["+", "*"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['slovak'] = {
	 'name': "Slovak - Sloven\u010dina", 'keys': [
	...
	this.VKI_layout['spanish'] = {
	 'name': "Spanish - Espa\u00f1ol", 'keys': [
	...
	this.VKI_layout['swedish'] = {
	 'name': "Swedish - Svenska", 'keys': [
		[["\u00a7", "\u00bd"], ["1", "!"], ["2", '"', "@"], ["3", "#", "\u00a3"], ["4", "\u00a4", "$"], ["5", "%", "\u20ac"], ["6", "&"], ["7", "/", "{"], ["8", "(", "["], ["9", ")", "]"], ["0", "=", "}"], ["+", "?", "\\"], ["\u00b4", "`"], ["Bksp", "Bksp"]],
		[["Tab", "Tab"], ["q", "Q"], ["w", "W"], ["e", "E", "\u20ac"], ["r", "R"], ["t", "T"], ["y", "Y"], ["u", "U"], ["i", "I"], ["o", "O"], ["p", "P"], ["\u00e5", "\u00c5"], ["\u00a8", "^", "~"], ["'", "*"]],
		[["Caps", "Caps"], ["a", "A"], ["s", "S"], ["d", "D"], ["f", "F"], ["g", "G"], ["h", "H"], ["j", "J"], ["k", "K"], ["l", "L"], ["\u00f6", "\u00d6"], ["\u00e4", "\u00c4"], ["Enter", "Enter"]],
		[["Shift", "Shift"], ["<", ">", "|"], ["z", "Z"], ["x", "X"], ["c", "C"], ["v", "V"], ["b", "B"], ["n", "N"], ["m", "M", "\u03bc", "\u039c"], [",", ";"], [".", ":"], ["-", "_"], ["Shift", "Shift"]],
	...
	this.VKI_layout['swiss-fr'] = {
	 'name': "Swiss (French) - Swiss (Francais)", 'keys': [
	...
	this.VKI_layout['swiss-de'] = {
	 'name': "Swiss German - Schweizerdeutsch", 'keys': [
		[["\u00A7", "\u00B0"], ["1", "+", "\u00A6"], ["2", '"', "@"], ["3", "*", "#"], ["4", "\u00E7", "\u00B0"], ["5", "%", "\u00A7"], ["6", "&", "\u00AC"], ["7", "/", "|"], ["8", "(", "\u00A2"], ["9", ")"], ["0", "="], ["'", "?", "\u00B4"], ["^", "`", "~"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['syriac'] = {
	 'name': "Syriac - \u0723\u0718\u072a\u071d\u071d\u0710", 'keys': [
	...
	this.VKI_layout['tamil'] = {
	 'name': "Tamil - \u0ba4\u0bae\u0bbf\u0bb4\u0bcd", 'keys': [
	...
	this.VKI_layout['tatar'] = {
	 'name': "Tatar - \u0422\u0430\u0442\u0430\u0440\u0447\u0430", 'keys': [
	...
	this.VKI_layout['telugu'] = {
	 'name': "Telugu - \u0c24\u0c46\u0c32\u0c41\u0c17\u0c41", 'keys': [
	...
	this.VKI_layout['thai-kedmanee'] = {
	 'name': "Thai Kedmanee - \u0e44\u0e17\u0e22 Kedmanee", 'keys': [
	...
	this.VKI_layout['thai-pattachote'] = {
	 'name': "Thai Pattachote - \u0e44\u0e17\u0e22 Pattachote", 'keys': [
	...
	this.VKI_layout['turkish-f'] = {
	 'name': "Turkish F - T\u00fcrk\u00e7e F", 'keys': [
		[['+', "*", "\u00ac"], ["1", "!", "\u00b9", "\u00a1"], ["2", '"', "\u00b2"], ["3", "^", "#", "\u00b3"], ["4", "$", "\u00bc", "\u00a4"], ["5", "%", "\u00bd"], ["6", "&", "\u00be"], ["7", "'", "{"], ["8", "(", '['], ["9", ")", ']'], ["0", "=", "}"], ["/", "?", "\\", "\u00bf"], ["-", "_", "|"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['turkish-q'] = {
	 'name': "Turkish Q - T\u00fcrk\u00e7e Q", 'keys': [
	...
	this.VKI_layout['ukrainian'] = {
	 'name': "Ukrainian - \u0423\u043a\u0440\u0430\u0457\u043d\u0441\u044c\u043a\u0430", 'keys': [
		[["\u00b4", "~"], ["1", "!"], ["2", '"'], ["3", "\u2116"], ["4", ";"], ["5", "%"], ["6", ":"], ["7", "?"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['uk'] = {
	 'name': "United Kingdom - United Kingdom", 'keys': [
		[["`", "\u00ac", "\u00a6"], ["1", "!"], ["2", '"'], ["3", "\u00a3"], ["4", "$", "\u20ac"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
	...
	this.VKI_layout['urdu-phonetic'] = {
	 'name': "Urdu Phonetic - \u0627\u0631\u062f\u0648 Phonetic", 'keys': [
	...
	this.VKI_layout['uzbek-cyr'] = {
	 'name': "Uzbek Cyrillic - \u040e\u0437\u0431\u0435\u043a\u0447\u0430", 'keys': [
	...
	this.VKI_layout['vietnamese'] = {
	 'name': "Vietnamese - Ti\u1ebfng Vi\u1ec7t", 'keys': [
	...
	this.VKI_layout['yiddish'] = { // from http://www.yv.org/uyip/hebyidkbd.txt http://uyip.org/keyboards.html
	 'name': "Yiddish - \u05d9\u05d9\u05b4\u05d3\u05d9\u05e9", 'keys': [
	...
	/* *************** Attach the keyboard icon to window **/
	VKI_attach = function() {
		if (document.getElementById("keyboardInputInitiator")) return false;
		var keybut = document.createElement('img');
		keybut.src = self.VKI_imageURI_g;
		keybut.alt = self.VKI_i18n['01'];
		keybut.id = "keyboardInputInitiator";
		keybut.title = self.VKI_i18n['01'];
		keybut.setAttribute('data-active', 1);
		if (self.VKI_emulate) {
			document.onkeypress = self.VKI_emulate_keypress;
			document.onkeydown = self.VKI_emulate_keydown;
		}
		...
		document.body.appendChild(keybut);
	};


	/* ***** Find tagged input & textarea elements, add listeners *** */
	function VKI_buildKeyboardInputs() {
		document.addEventListener('click', function(e) {
			if (document.getElementById("keyboardInputInitiator").getAttribute('data-active') == 1) {
				e = e || window.event;
				var ex = e.target || e.srcElement;
				if (ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password" || ex.type == "search" || ex.type == "url" || ex.type == "email") {
					self.VKI_show(ex);
				}
			}
		}, false);
		...
		for (var x = 0, elem; elem = inputElems[x++];) {
			for (var y = 0, ex; ex = elem[y++];) {
				if (ex.nodeName == "TEXTAREA" || ex.type == "text" || ex.type == "password"
						|| ex.type == "search" || ex.type == "url" || ex.type == "email" ) {
						//ex.addEventListener('focus', function() { self.VKI_show(this); }, false);
				}
			}
		}
		*/
	...
	/* **** switch mini keayboard from off to on or from on to off **** */
	function VKI_switch_minikb() {
		var  k = document.getElementById("keyboardInputInitiator");
		k.setAttribute('data-active', ((k.getAttribute('data-active') == '1') ? '0' : '1'));
		k.src = (k.getAttribute('data-active') == '1') ? self.VKI_imageURI_g : self.VKI_imageURI_r;
	}
	...
	this.VKI_dndOnMouseDown = function(e) {
		if (e == null) e = window.event; 

		var w = self.VKI_keyboard.getBoundingClientRect(); // position keyboard on screen
		var p = [self.VKI_keyboard.offsetLeft, self.VKI_keyboard.offsetTop]; // position of keyboard in dom layouth
		var k = [self.VKI_keyboard.offsetWidth, self.VKI_keyboard.offsetHeight]; // keyboard sizes
		var d = [document.getElementsByTagName('html')[0].clientWidth, document.getElementsByTagName('html')[0].clientHeight]; // dimensions visible area
		var x = - (e.clientX || 0);
		var y = - (e.clientY || 0);
		//  start moving the element with the mouse
		document.onmousemove = function(e) {
			self.VKI_keyboard.style.top  = Math.min((Math.max((y+e.clientY+k[1]), - w.top+k[1])),  (d[1]-w.top-5))  - k[1]+p[1]+3 + 'px';
			self.VKI_keyboard.style.left = Math.min((Math.max((x+e.clientX+k[0]), - w.left+k[0])), (d[0]-w.left-5)) - k[0]+p[0]+3 + 'px';
		};
		// prevent selection bug
		return false;
	}

	this.VKI_dndOnMouseUp = function(e) {
	...
	var div = document.createElement('div');
		 var select = document.createElement('select');
			for (ktype in this.VKI_layout) {
				if (typeof this.VKI_layout[ktype] == "object") {
				 ...
				 var option = document.createElement('option');
					...
					VKI_addListener(select, 'change', function(e) {
						e = e || event;
						if (e.stopPropagation) { e.stopPropagation(); } else e.cancelBubble = true;
						self.VKI_kts = self.VKI_kt = select.value;
						self.VKI_buildKeys();
					}, false);

					option.appendChild(document.createTextNode(this.VKI_layout[ktype].name));
					option.value = ktype;
					if (self.VKI_kts == ktype) option.selected = true;
			...
			var move = document.createElement('span');
				move.title = this.VKI_i18n['07'];
				move.onmousedown = this.VKI_dndOnMouseDown;
				document.onmouseup = this.VKI_dndOnMouseUp;
			...
			var strong = document.createElement('strong');
				...
				VKI_addListener(strong, 'click', function() { self.VKI_x_close(); }, false);
				VKI_mouseEvents(strong);
				div.appendChild(strong);

	this.VKI_keyboard.appendChild(div);
		// dead keys chk box
		var label = document.createElement('label');
		var checkbox = document.createElement('input');
		checkbox.type = "checkbox";
		checkbox.title = this.VKI_i18n['03'] + ": " + this.VKI_i18n['05'];
	...
	this.VKI_buildKeys = function() {
		this.VKI_shift = this.VKI_shiftlock = this.VKI_altgr = this.VKI_altgrlock = false;
		var container = this.VKI_keyboard.getElementsByTagName('div')[0];
		var tables = container.getElementsByTagName('table');
		for (var x = tables.length - 1; x >= 0; x--) container.removeChild(tables[x]);

		for (var x = 0, i=1, hasDeadKey = false, lyt; lyt = this.VKI_layout[this.VKI_kt].keys[x++];) {
			var table = document.createElement('table');
			table.cellSpacing = "0";
			if (lyt.length <= 3) table.className = "keyboardInputCenter";
			...
			for (var y = 0, lkey; lkey = lyt[y++];) {
				...
				switch (lkey[1]) {
					...
					case "Alt": case "AltGr": case "AltLk":
						...
						td.className += " "+lkey[1].toLowerCase();
						break;
				...
				td.id = 'vki_'+i;
				tr.appendChild(td);
				for (var z = 0; z < 4; z++) if (this.VKI_deadkey[lkey[z] = lkey[z] || ""]) hasDeadKey = true;
				i++;
			} table.appendChild(tr);
			container.appendChild(table);
		}
		this.VKI_deadkeysOn.style.display = "inline";
	};
	...
	this.VKI_modify = function(type) {
		...
		var tables = this.VKI_keyboard.getElementsByTagName('div')[0].getElementsByTagName('table');
		for (var x = 0; x < tables.length; x++) {
			...
			for (var y = 0; y < tds.length; y++) {
				...
				switch (lkey[1]) {
					case "Alt":
					case "AltGr":
						className.push(" "+lkey[1].toLowerCase());
					...
					case "Caps":
						...
						break;
					case "Tab": case "Enter": case "Bksp": className.push(" "+lkey[1].toLowerCase()); break;
					default:
						if (type) {
	...
	*/
	this.VKI_insert = function(text) {
		...
		this.VKI_target.maxlength < 0 || this.VKI_target.value.length < this.VKI_target.maxlength) {
	...
	/* ****************************************************************
	* Show the keyboard interface on first launch
	*  or pin it to a specific input "elem" : id of the input.
	*
	*/
	this.VKI_show = function(elem) {
		if (document.getElementById('keyboardInputInitiator').getAttribute('data-active') == '0') return;
		if (!this.VKI_target || this.VKI_target != elem) {
			if (!this.VKI_target) var VKInew = true;
			this.VKI_target = elem;
			if (VKInew) {
				if (VKI_getStyle(elem, "position") == "fixed") this.VKI_target.keyboardPosition = "fixed";
	...
	this.VKI_position = function() {
		if (self.VKI_target) {
			var wDim = [self.innerWidth, self.innerHeight]; // dimentions of the window
			var scr = self.VKI_target;
			var fudge = scr.offsetHeight + 3; // offset from top of input
			var iPos = [scr.offsetLeft, scr.offsetTop]; // position in HTML document of target
			var win = scr.getBoundingClientRect(); // position on screen of target
			var kbs = [this.VKI_keyboard.offsetWidth, this.VKI_keyboard.offsetHeight]; // keyboard sizes
			// top
			if (win.top+fudge+kbs[1]>wDim[1] && ((win.top-kbs[1]-3)>0)) { // le KB sort verticalement de l’écran
				self.VKI_keyboard.style.top = iPos[1] - kbs[1] - 3  + ((!this.VKI_isWebKit) ? document.body.scrollTop : 0 ) + "px";
			} else {
				self.VKI_keyboard.style.top = iPos[1] + fudge + ((!this.VKI_isWebKit) ? document.body.scrollTop : 0 ) + "px";
			}
			// left
			if (win.left+kbs[0]>wDim[0]) {
				self.VKI_keyboard.style.left = iPos[0] - (kbs[0] - scr.offsetWidth) + "px";
			} else {
				self.VKI_keyboard.style.left = iPos[0] + "px";
			}
		}
	};
	...
	/* ********************* Close keyboard with the X button. */
	this.VKI_x_close = function() {
		VKI_switch_minikb();
		VKI_close();
	}

	/* ******************** on keypress on real keyboard, insert the matching caracter on the VK */
	this.VKI_emulate_keydown = function(event) {
		if (document.getElementById("keyboardInputInitiator").getAttribute('data-active') == 0) return;
		var key = false;

		if (event.shiftKey) { key = 42; }
		if (event.altKey) { key = 57; }
		if (event.keyCode == 20) { key = 29; } // capsLock

		if (key) {
			var evt = document.createEvent("MouseEvents"); // créer un évennement souris
			evt.initMouseEvent("click", true, true, window, 0, 0, 0, 0, 0, false, false, false, false, 0, null);
			var cb = document.getElementById('vki_' + key);
	...
	this.VKI_emulate_keypress = function(event) {
		if (document.getElementById("keyboardInputInitiator").getAttribute('data-active') == 0) return;
		var ch = (event.which || event.keyCode);
		var match_lyt = {
			// First level keyboard
			'178':"1", '38':"2", '233':"3", '34':"4", '39':"5", '40':"6", '45':"7", '232':"8", '95':"9", '231':"10", '224':"11", '45':"12", '43':"13",
			'97':"16", '122':"17", '101':"18", '114':"19", '116':"20", '121':"21", '117':"22", '105':"23", '111':"24", '112':"25", '94':"26", '36':"27",
			'113':"30", '115':"31", '100':"32", '102':"33", '103':"34", '104':"35", '106':"36", '107':"37", '108':"38", '109':"39", '249':"40", '42':"28",
			'60':"43", '119':"44", '120':"45", '99':"46", '118':"47", '98':"48", '110':"49", '44':"50", '59':"51", '58':"52", '33':"53",

			// caps level
			'178':"1", '38':"2", '201':"3", '34':"4", '39':"5", '40':"6", '45':"7", '200':"8", '95':"9", '199':"10", '192':"11", '45':"12", '43':"13",
			'65':"16", '90':"17", '69':"18", '82':"19", '84':"20", '89':"21", '85':"22", '73':"23", '79':"24", '80':"25", '94':"26", '36':"27",
			'81':"30", '83':"31", '68':"32", '70':"33", '71':"34", '72':"35", '74':"36", '75':"37", '76':"38", '77':"39", '217':"40", '42':"28",
			'60':"43", '87':"44", '88':"45", '67':"46", '86':"47", '66':"48", '78':"49", '44':"50", '59':"51", '58':"52", '33':"53"

		};
		if (match_lyt[ch]) {
			var evt = document.createEvent("MouseEvents"); // créer un évennement souris
			evt.initMouseEvent("click", true, true, window, 0, 0, 0, 0, 0, false, false, false, false, 0, null);
			var cb = document.getElementById('vki_' + match_lyt[ch]);
			cb.dispatchEvent(evt);
			event.preventDefault();
		}
	}
